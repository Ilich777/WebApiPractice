...
namespace WebApiPractice.JwtAuth.Auth
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        [HttpPost] //Invoke-RestMethod http://localhost:41158/api/authenticate/register -Method POST -Body (@{username = "user"; email = "user@mail.ru"; password = "123"} | ConvertTo-Json) -ContentType "application/json; charset=utf-8"
        [Route("register")]
